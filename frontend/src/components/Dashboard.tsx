      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-100 pb-5">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Here is an overview of your dynamic workspace and project metrics.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <h3 className="text-3xl font-bold text-slate-900">{totalBoards}</h3>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-slate-400 font-semibold">{boards.length} Boards</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {boards.map((board) => (
              <div
                key={board.id}
                className="group relative bg-white rounded-2xl border border-slate-100 shadow-xs hover:shadow-md hover:border-slate-200/80 transition duration-300 overflow-hidden flex flex-col justify-between"
              >
                ...
                <div className="px-5 py-3 bg-slate-50 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="p-1.5 hover:bg-white rounded hover:text-slate-600 transition cursor-pointer"
                      title="Edit Board"
                    >
        ...
        <div className="space-y-5 bg-white p-6 rounded-2xl border border-slate-100 shadow-xs h-fit">
